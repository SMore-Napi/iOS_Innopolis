...
class HabitCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(NamedSectionHeaderView.self,
           ...
           withReuseIdentifier: SectionHeader.kind.identifier)
    }
    ...
    func createDataSource() -> DataSourceType {
        ...
        dataSource.supplementaryViewProvider = { (collectionView, kind,
           indexPath) in
            ...
            SectionHeader.kind.identifier, withReuseIdentifier: SectionHeader.kind.identifier, for: indexPath) as! NamedSectionHeaderView
    ...
    func createLayout() -> UICollectionViewCompositionalLayout {
        ...
        let sectionHeader =
           ...
           headerSize, elementKind: SectionHeader.kind.identifier, alignment: .top)
