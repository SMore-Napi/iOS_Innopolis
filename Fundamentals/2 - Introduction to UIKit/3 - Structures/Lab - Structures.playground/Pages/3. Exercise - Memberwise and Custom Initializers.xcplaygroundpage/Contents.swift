...
var favoriteBook = Book(title: "Elegant Objects", author: "Yegor Bugayenko", pages: 223, price: 40.96)
print("I won the book '\(favoriteBook.title)' written by \(favoriteBook.author) which has \(favoriteBook.pages) pages and costs \(favoriteBook.price)$.")
/*:
...
var macBookAir = Laptop(yearPurchased: 2018)
/*:
