...
var shapesArray = ["Rectangle", "Circle"]
var colorsArray = ["Red", "Blue", "Green"]
var dictionaryArrays: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(dictionaryArrays)
...
if let colors = dictionaryArrays["Colors"] {
    print(colors.last!)
}
/*:
