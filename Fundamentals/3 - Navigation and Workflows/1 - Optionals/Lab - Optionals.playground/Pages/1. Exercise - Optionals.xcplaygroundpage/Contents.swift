...
// Error: Int initializer return optional Int?, but 'userAge' was declated as Int
...
print(userAge)
// Int initializer couldn't convert the string 'userInputAge' value into integer. So, it returned nil
/*:
