...
// Since both constants are Doubles, the result will be the decimal number
/*:
...
print(even % 2)
print(odd % 2)
// If the remainder is 0 after the 'mod' division by 2, then it is even number, otherwise - odd
/*:
