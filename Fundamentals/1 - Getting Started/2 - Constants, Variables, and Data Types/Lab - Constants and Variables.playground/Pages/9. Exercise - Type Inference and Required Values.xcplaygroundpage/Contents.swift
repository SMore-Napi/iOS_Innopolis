 ...
 */
var name: String
// No, it doesn't compile because we haven't assigned a value to the variable
// Once the value is assigned, the variable becomes available.
...
// Initially, it won't compile because a compiler automatically assigned a type 'Int'.
// We can't assign a number with a floating point beacause such number is represented as 'Double'
// So, we need to explicitly declare a 'Double' type of `distanceTraveled` variable to avoid type conflicts.
/*:
